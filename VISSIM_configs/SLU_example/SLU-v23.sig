...
<sc version="201602" id="3" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="1576006610">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="Signal group mercer" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="2" name="mercer left turn" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
    ...
    <sg id="3" name="Signal group fairview" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
    ...
    <sg id="4" name="fairview left turn" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="98000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
