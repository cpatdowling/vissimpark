...
<sc version="201602" id="2" name="" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="872238335">
  <signaldisplays>
  ...
  <sgs>
    ...
    <sg id="2" name="Left turn Terry" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="50000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
